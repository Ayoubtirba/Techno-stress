					...
					<div class="table100-body js-pscroll">
						...
						<thead>
								<tr class="row100 head">
								   ...
								   <c:forEach  var="U" items="${requestScope.Psys}">
							<tbody>
								<tr class="row100 body">
									<td class="cell100 column1">${U.nom}</td>
								<td class="cell100 column1">${U.prenom}</td>
								<td class="cell100 column1">${U.email}</td>
								<td class="cell100 column1"><a href="Choix?action=ajouterclef&idPsy=${U.id}&iduser=<%=request.getParameter("iduser")%>&idfile=<%=request.getParameter("idfile")%>">Choisir</a></td>
								</tr>
