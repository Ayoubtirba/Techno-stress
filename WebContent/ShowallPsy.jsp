		...
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100 ver5 m-b-110 input100">
				 <ul>
        <li><a href="AjouterPsy.jsp">Ajouter Psy</a></li>
        </ul>
					...
					<div class="table100-body js-pscroll">
						...
						<thead>
								<tr class="row100 head">
								  ...
								  <c:forEach  var="P" items="${requestScope.Psys}">
							<tbody>
								...
								<td  class="cell100 column1"><a href="Psy?action=SupprimierPsy&id=${P.id}"><i class="fa fa-trash-o" width></i></a>
              <a href="Psy?action=showPsy&id=${P.id}"><i class="fa fa-pencil-square-o"></i></a></td>
